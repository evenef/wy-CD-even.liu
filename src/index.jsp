...
<style>
	...
	.item0 .type_1_txt,.item1 .type_1_txt,.item4 .type_1_txt,.item5 .type_1_txt{
		background:url("images/part1_txtbg_b.png") no-repeat;
		background-size:440px;
	}
	.part_1 .right_side .item0_focus .type_1_txt,.item1_focus .type_1_txt,.item2_focus .type_1_txt,.item3_focus .type_1_txt,.item4_focus .type_1_txt,.item5_focus .type_1_txt,.item6_focus .type_1_txt,.item7_focus .type_1_txt{
		position: absolute;
		top: 178px;
		width:479px;
		height:55px;
	...
	.item2_focus .type_1_txt,.item3_focus .type_1_txt,.item6_focus .type_7_txt{
		background:url("images/part1_txtbg_g.png") no-repeat;
		background-size: 479px;
	}
	...
	.part_1 .left_side .item_focus .type_2 .type_2_txt,.part_1 .left_side .item_focus .type_1 .type_1_txt{
		position:absolute;
		top:171px;
		left:-10px;
		width:233px;
	...
	.part_1 .left_side .item_focus .type_1 .type_1_txt{
		position: absolute;
		top: 167px;
		left: -20px;
		width: 478px;
	...
	.part_2 .item5_focus .type_1 .type_1_txt,.part_2 .item6_focus .type_1 .type_1_txt,.part_2 .item7_focus .type_1 .type_1_txt
	{
		...
		/***part3_视频中心***/
.videoCenter{position:absolute;left:83px;top:0;width:1150px;height:450px;}
...
.videoCenter .item .videoCenterTxt{position:absolute;top:187px;left:0px;width:258px;line-height:56px;font-size:22px;text-align:center;color:#000;}
			...
			<div class="part_3">
				<div class="videoCenter">
                    ...
                    <div class="item" style="top:254px;left:861px;" id="area55_7">
                        ...
                        <div id="area55_txt_7" class="videoCenterTxt"></div>
                    </div>
                </div>
			</div>
			<div class="part_4">
...
<script>
	...
	var epgDoman="";
	var epgToken="";
	var _curAreaIndex=_curAreaInfo=0//保存的焦点信息
	try{
...
//		document.getElementById("_test").innerHTML = "isFristEnter:" + isFristEnter;
		...
		if(isFristEnter)
			window.location.href = window.location.origin + '/Wanba/active/HanJiaDaFangSong/index.html?UserID=' + UserID + '&ReturnURL=' + escape(window.location.href)
	...
	function loadElement(){
        ...
        area62.doms[0].okEvent=function(){
            ...
            window.location.href = "http://" + ip + "/Wanba/active/exchangeStore/index.html?UserID=" + epg_userid + "&ReturnURL=" + returnURL;
        };
        area62.doms[1].okEvent=function(){
            ...
            var returnURL = "http://" + ip + window.location.pathname;
			focus_logic.setCookie("content_left","1px");
            window.location.href = "http://" + ip + "/Wanba/active/registerCards/index.html?UserID=" + epg_userid + "&ReturnURL=" + returnURL;
        }
        updateStatus();
	}
	...
	function setAreaAttr(){
		...
		area55.doms[4].moveDirectionEvent=function(direction){
			if(direction==1){
				change_screen(2);
				checke_nav_focus();
				area55.doms[4].moveRule=[-1,53,-1,-1];
			}else if(direction==3){
				if(area55.curDomIndex==(area55.d5omsCount-1)){
					change_screen(4);
					checke_nav_focus();
				}
			}
	...
	function load_video(result){
		...
		var tmp_size=video_data.object.size>8?8:video_data.object.size;
		area55.setDataCount(tmp_size,"area55_");
		area55.setAttrForDomsTxt(video_data.object.list,"name","name",1,"area55_txt_");
	...
	function getLastVersion() {
		focus_logic.getDataByAjax("get_data/get_data.jsp?action=updateVersion&url=" + get_ip + "wbupdate/update.do&apkvcode=" + currentVersion + "&zipvcode=3200&userName=" + epg_userid, parserLastVersion);
		return lastVersion;
	}
	...
	function parserLastVersion(result) {
		try {
			...
			if ("0" == _rltcode && vserionResult.object != undefined) {
				...
				downloadUrl = vserionResult.object.apkurl;
			} else {
